...
(function () {
    ...
    var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = location.origin + '/wm/uncrustify.data';
        var REMOTE_PACKAGE_BASE = location.origin + '/wm/uncrustify.data';
...
var wasmBinaryFile;
wasmBinaryFile = location.origin + '/wm/uncrustify.wasm';
